...
static void _Trace(LPCTSTR pszFormat, ...)
{
	...
	//w(v)sprintfÇÕ1024ï∂éöà»è„ï‘ÇµÇƒÇ±Ç»Ç¢
	TCHAR szBuffer[10240];
	wvsprintf(szBuffer, pszFormat, argptr);

	//ÉfÉoÉbÉKÇÉAÉ^ÉbÉ`ÇµÇƒÇÈéûÇÕÉfÉoÉbÉKÇ…ÉÅÉbÉZÅ[ÉWÇèoÇ∑
...
//å^É`ÉFÉbÉNã@î\Ç¬Ç´DeleteXXX/SelectXXX
//SelectObject/DeleteObjectÇÕégópÇ≈Ç´Ç»Ç≠Ç»ÇÈ
...
//String to intÁ≠âÁ≥ªÂàóÂáΩÊï∞ÁöÑÂÆö‰πâ
/*
