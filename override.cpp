...
Params g_D2DParamsSmall, g_D2DParamsLarge;
...
bool MakeD2DParams(IDWriteFactory* dw_factory)
{
	...
	g_D2DParamsSmall.Gamma = pSettings->GammaValue()*pSettings->GammaValue()/2;
	g_D2DParamsSmall.EnhancedContrast = 0.0f;
	g_D2DParamsSmall.ClearTypeLevel = 0.7f;
	switch (pSettings->GetFontSettings().GetAntiAliasMode())
	{
	case 2:
	case 4:
		g_D2DParamsSmall.PixelGeometry = DWRITE_PIXEL_GEOMETRY_RGB;
		break;
	case 3:
	case 5:
		g_D2DParamsSmall.PixelGeometry = DWRITE_PIXEL_GEOMETRY_BGR;
		break;
	default:
		g_D2DParamsSmall.PixelGeometry = DWRITE_PIXEL_GEOMETRY_FLAT;
	}

	memcpy(&g_D2DParamsLarge, &g_D2DParamsSmall, sizeof(g_D2DParamsSmall));
	if (pSettings->GetFontSettings().GetHintingMode()==1)
	{
		g_D2DParamsLarge.AntialiasMode = (D2D1_TEXT_ANTIALIAS_MODE)D2D1_TEXT_ANTIALIAS_MODE_DEFAULT;
		g_D2DParamsLarge.RenderingMode = (DWRITE_RENDERING_MODE)DWRITE_RENDERING_MODE_CLEARTYPE_NATURAL_SYMMETRIC;
	}
	else
	{
		g_D2DParamsLarge.AntialiasMode = (D2D1_TEXT_ANTIALIAS_MODE)D2D1_TEXT_ANTIALIAS_MODE_DEFAULT;
	...
	g_D2DParamsSmall.AntialiasMode = (D2D1_TEXT_ANTIALIAS_MODE)D2D1_TEXT_ANTIALIAS_MODE_DEFAULT;
	g_D2DParamsSmall.RenderingMode = (DWRITE_RENDERING_MODE)DWRITE_RENDERING_MODE_CLEARTYPE_NATURAL_SYMMETRIC;



/*
	if (g_D2DParamsSmall.RenderingParams) {
		g_D2DParamsSmall.RenderingParams->Release();
	}*/

	if (FAILED(dw_factory->CreateCustomRenderingParams(
		g_D2DParamsSmall.Gamma,
		g_D2DParamsSmall.EnhancedContrast,
		g_D2DParamsSmall.ClearTypeLevel,
		g_D2DParamsSmall.PixelGeometry,
		g_D2DParamsSmall.RenderingMode,
		&g_D2DParamsSmall.RenderingParams)))
		return false;
	if (FAILED(dw_factory->CreateCustomRenderingParams(
		g_D2DParamsLarge.Gamma,
		g_D2DParamsLarge.EnhancedContrast,
		g_D2DParamsLarge.ClearTypeLevel,
		g_D2DParamsLarge.PixelGeometry,
		g_D2DParamsLarge.RenderingMode,
		&g_D2DParamsLarge.RenderingParams)))
		return false;
	return true;
}
...
void WINAPI IMPL_DrawGlyphRun(ID2D1RenderTarget* self,
							  D2D1_POINT_2F baselineOrigin,
							  const DWRITE_GLYPH_RUN *glyphRun,
							  ID2D1Brush *foregroundBrush,
							  DWRITE_MEASURING_MODE measuringMode)
{
	Params& currentParams = /*glyphRun->fontEmSize<13 ? g_D2DParamsSmall:*/g_D2DParamsLarge;
	self->SetTextAntialiasMode(currentParams.AntialiasMode);
	self->SetTextRenderingParams(currentParams.RenderingParams);
	return ORIG_DrawGlyphRun(self, baselineOrigin, glyphRun, foregroundBrush, measuringMode);
}
