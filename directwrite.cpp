...
bool MakeD2DParams(IDWriteFactory* dw_factory)
{
	...
	switch (pSettings->RenderingModeForDW())
	{
	case 0:
		g_D2DParams.RenderingMode = (DWRITE_RENDERING_MODE)DWRITE_RENDERING_MODE_DEFAULT;
		break;
	case 1:
		g_D2DParams.RenderingMode = (DWRITE_RENDERING_MODE)DWRITE_RENDERING_MODE_ALIASED;
		break;
	case 2:
		g_D2DParams.RenderingMode = (DWRITE_RENDERING_MODE)DWRITE_RENDERING_MODE_CLEARTYPE_GDI_CLASSIC;
		break;
	case 3:
		g_D2DParams.RenderingMode = (DWRITE_RENDERING_MODE)DWRITE_RENDERING_MODE_CLEARTYPE_GDI_NATURAL;
		break;
	case 4:
		g_D2DParams.RenderingMode = (DWRITE_RENDERING_MODE)DWRITE_RENDERING_MODE_CLEARTYPE_NATURAL;
		break;
	case 5:
